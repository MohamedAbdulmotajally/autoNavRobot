	...
	if( LOC_u64Fraction > 1500 ){ LOC_u64Mantissa += 1 ; LOC_u64Fraction  = 0 ; }
		...
		MUSART3 -> SR = 0 ;
			...
			CLEAR_BIT( MUSART3 -> CR1 , 12 );
					...
					CLEAR_BIT( MUSART3 -> CR1 , 10 );

		#elif USART1_PARITY == EVEN_PARITY

					SET_BIT( MUSART3 -> CR1 , 10 );
					CLEAR_BIT( MUSART3 -> CR1 , 11 );
					...
					CLEAR_BIT( MUSART3 -> CR1 , 5 );
					CLEAR_BIT( MUSART3 -> CR1 , 6 );
					CLEAR_BIT( MUSART3 -> CR1 , 7 );
					...
					CLEAR_BIT( MUSART3 -> CR1 , 2 );

		#endif

		#if   USART1_STOP_BITS == ONE_STOP_BIT

					CLEAR_BIT( MUSART3 -> CR2 , 12 ); CLEAR_BIT( MUSART3 -> CR2 , 13 );

		#elif USART1_STOP_BITS == HALF_STOP_BIT

					SET_BIT( MUSART3 -> CR2 , 12 ); CLEAR_BIT( MUSART3 -> CR2 , 13 );

		#elif USART1_STOP_BITS == TWO_STOP_BIT

					CLEAR_BIT( MUSART3 -> CR2 , 12 ); SET_BIT( MUSART3 -> CR2 , 13 );
		...
		MUSART3 -> BRR = ( LOC_u64Mantissa << 4  ) | ( LOC_u64Fraction / 100 ) ;
		SET_BIT( MUSART3 -> CR1 , 13 );

	#elif USART1_STATUS == USART1_DISABLE
		CLEAR_BIT( MUSART3 -> CR1 , 0 );
